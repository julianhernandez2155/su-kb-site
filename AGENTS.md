...
Public GitHub Pages knowledge base replacing Confluence for **Syracuse University's ITS Data & AI department**. Built on Quartz v4. Two consumers: humans browsing (clementine.syr.edu styling) and Codex's `WebFetch` via an org-wide Codex skill.
...
| [skill/](skill/) | The Codex skill that students install to route WebFetch to this site |
...
| Edit the Codex skill | [skill/](skill/) | `skill/CONTEXT.md` |
